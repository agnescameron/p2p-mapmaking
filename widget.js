...
(function() {
    ...
    var is = {
        ...
        set: function(shape) {
            ...
            cache.isLine = cache.isArrow = cache.isImportMap = cache.isArc = cache.isDragLastPath = cache.isDragAllPaths = cache.isRectangle = cache.isQuadraticCurve = cache.isBezierCurve = cache.isPencil = cache.isMarker = cache.isEraser = cache.isText = cache.isImage = cache.isPdf = false;
            cache['is' + shape] = true;
        }
    };
    ...
    addEvent(canvas, isTouch ? 'touchstart mousedown' : 'mousedown', function(e) {
        ...
        else if (cache.isImportMap) importMapHandler.mousedown(e);
